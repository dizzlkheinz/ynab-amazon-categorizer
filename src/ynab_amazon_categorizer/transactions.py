...
def fetch_amazon_transactions(
    ...
    return [transaction for transaction in transactions if _should_process(transaction)]


def _should_process(transaction: YNABTransaction) -> bool:
    ...
    return bool(
        ...
        and transaction.get("cleared") != "reconciled"
